...
- [ ] Finish the **Learn SQL** course on boot.dev (databases fundamentals)
- [ ] Complete more **TryHackMe** paths
- [ ] Land an internship in IT / data-related field
- [ ] Explore data science basics (Python + Pandas)
...
<img src="https://skillicons.dev/icons?i=python,go,linux,docker,git,github,mysql,html,css,bootstrap&theme=dark" />
